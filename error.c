...
void error_print (int ne)
{
    ...
    case 84:
        ...
        break;
    case 85:
        printf("\t Error : Las Constantes String sólo se pueden utilizar en una proposición de Entrada-Salida\n");
        break;
    case 86:
        printf("\t Error : La cantidad de Inicializadores es superior a la capacidad del Arreglo declarado\n");
        break;
    }
}
